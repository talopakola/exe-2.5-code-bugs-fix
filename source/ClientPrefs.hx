...
class ClientPrefs {
	...
	public static var hideTime:Bool = false; //This is boring :|
	public static var gore:Bool = true;
	public static var disableTimeBarAndBG:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.disableTimeBarAndBG = disableTimeBarAndBG; //I love this <3333
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.disableTimeBarAndBG != null) {
			disableTimeBarAndBG = FlxG.save.data.disableTimeBarAndBG;
		}
