...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_dodge = new FlxUICheckBox(110, 70, null, null, "Can dodge", 100);
		check_dodge.checked = _song.canDodge;
		// _song.needsVoices = check_voices.checked;
		check_dodge.callback = function()
		{
			_song.canDodge = check_dodge.checked;
			trace('CHECKED!');
		};
		...
		tab_group_song.add(check_dodge);
